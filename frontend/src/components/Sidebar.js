  ...
  return (
    <>
      ...
      >
        ...
        <TouchableOpacity style={styles.sidebarItem} onPress={() => navigation.navigate("Feedback")}>
          <MaterialIcons name="feedback" size={22} color="#2f95dc" style={styles.icon} />
          <Text style={[styles.sidebarText, { color: "#2f95dc" }]}>Feedback</Text>
        </TouchableOpacity>
